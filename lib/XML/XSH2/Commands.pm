...
'change-ns-uri' => ['change_namespace_uri', 1, 2],
'change-ns-prefix' => ['change_namespace_prefix', 1, 2],
'set-ns' => ['set_namespace', 1, 2,
	{
	 'p' => 'prefix',
	 'prefix' => 'string',
	}],
'declare-ns' => ['declare_namespace', 2, 2],
'set' => ['xpath_set', 1, 2],
'exp' => 'get',
'expr' => 'get',
'get' => ['expr', 1, 1],
'perl' => ['perl_eval_command', 1, 1],
'rm' => 'remove',
'prune' => 'remove',
'delete' => 'remove',
'del' => 'remove',
