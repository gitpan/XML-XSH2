...
With XSH2, it is possible to browse B<document trees> as if they were a local filesystem, except that B<XPath> expressions are used instead of ordinary UNIX paths.
...
canonical, count, defs, doc-info, documents, dtd, enc, get, help, lineno, locate, ls, namespaces, print, pwd, settings, validate, variables, version
...
print [--nonlE<verbar>:n] B<expression> [B<expression> ...]
...
wrap B<expression> [namespace B<expression>] B<xpath>
